...
"""
    Negotiation Strategy: Simpleton

    Command line start: python Simpleton.py -m babajaga123@jix.im -id lgaaric@jix.im -pwd lgaric

"""

class Simpleton(Agent):
    ...
    def say(self, msg):
        print(f"[Simpleton] {msg}")

    def sayBold(self, msg):
        print('\033[1m' + f"[Simpleton] {msg}" + '\033[0m')
...
if __name__ == '__main__':
    ...
    agent = Simpleton(args.id, args.pwd, MiddleMan=args.MiddleMan)
    agent.start()
