...
"""
    Negotiation Strategy: Always Cooperate

    Command line start: python AlwaysCooperate.py -m babajaga123@jix.im -id lgaric@jix.im -pwd lgaric
...
class AlwaysCooperate(Agent):
    ...
    class NegotiateResponse(State):
        ...
        async def run(self):
            self.cheat = False # I never cheat! :)
    ...
    def say(self, msg):
        print(f"[Always Cooperate] {msg}")

    def sayBold(self, msg):
        print('\033[1m' + f"[Always Cooperate] {msg}" + '\033[0m')
